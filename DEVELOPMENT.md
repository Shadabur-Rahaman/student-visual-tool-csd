...
```bash
git remote add encore encore://student-visual-tool-amti
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/student-visual-tool-amti/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/student-visual-tool-amti/settings/integrations/github)
